...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "com.snake.sadragame", "com.snake.sadragame.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "com.snake.sadragame.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
